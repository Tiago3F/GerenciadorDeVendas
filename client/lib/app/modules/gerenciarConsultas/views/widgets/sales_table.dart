...
class SalesTableScren extends StatefulWidget {
  SalesTableScren({Key? key, this.title}) : super(key: key);
  final String? title;
  @override
  _SalesTableScrenState createState() => _SalesTableScrenState();
}

class _SalesTableScrenState extends State<SalesTableScren> {
